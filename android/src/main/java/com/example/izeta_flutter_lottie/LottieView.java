...
public class LottieView implements PlatformView, MethodChannel.MethodCallHandler {
    ...
    void create(Map<String, Object> args) {
        ...
        channel = new MethodChannel(mRegistrar.messenger(), "izeta/flutter_lottie_" + mId);
        channel.setMethodCallHandler(this);

        final EventChannel onPlaybackCompleteEventChannel = new EventChannel(mRegistrar.messenger(), "izeta/flutter_lottie_stream_playfinish_" + mId);
