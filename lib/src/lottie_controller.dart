...
class LottieController {
  ...
  LottieController(int id) {
    this.id = id;
    print('Creating Method Channel izeta/flutter_lottie_$id');
    this._channel = new MethodChannel('izeta/flutter_lottie_$id');
    this._playFinished = EventChannel('izeta/flutter_lottie_stream_playfinish_$id');
  }
